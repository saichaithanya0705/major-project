...
draw_bounding_box_declaration = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "y_min": {"type": "integer", "description": "Top edge in Gemini-style 0-1000 image coordinates."},
            "x_min": {"type": "integer", "description": "Left edge in Gemini-style 0-1000 image coordinates."},
            "y_max": {"type": "integer", "description": "Bottom edge in Gemini-style 0-1000 image coordinates."},
            "x_max": {"type": "integer", "description": "Right edge in Gemini-style 0-1000 image coordinates."},
...
draw_point_declaration = {
    ...
    "parameters": {
        ...
        "properties": {
            "time": {"type": "number", "description": "Time offset in seconds for when to run this action."},
            "x_pos": {"type": "integer", "description": "X position of the dot in Gemini-style 0-1000 image coordinates."},
            "y_pos": {"type": "integer", "description": "Y position of the dot in Gemini-style 0-1000 image coordinates."},
            "text": {"type": "string", "description": "The label text to display."},
            "text_x": {"type": "integer", "description": "X position of the text label in Gemini-style 0-1000 image coordinates."},
            "text_y": {"type": "integer", "description": "Y position of the text label in Gemini-style 0-1000 image coordinates."},
...
create_text_declaration = {
    ...
    "parameters": {
        ...
        "properties": {
            "time": {"type": "number", "description": "Time offset in seconds for when to run this action."},
            "x": {"type": "integer", "description": "X coordinate in Gemini-style 0-1000 image coordinates."},
            "y": {"type": "integer", "description": "Y coordinate in Gemini-style 0-1000 image coordinates."},
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "box": {
                "type": "object",
                "properties": {
                    "x": {"type": "integer", "description": "Box left edge in Gemini-style 0-1000 image coordinates."},
                    "y": {"type": "integer", "description": "Box top edge in Gemini-style 0-1000 image coordinates."},
                    "width": {"type": "integer", "description": "Box width in Gemini-style 0-1000 image coordinates."},
                    "height": {"type": "integer", "description": "Box height in Gemini-style 0-1000 image coordinates."},
                },
